...
class ProjectSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Project::create([
            ...
            'details' => 'Group project to enhance the accessibility of the Haskell Educational Advancement Tool (HEAT) through the addition of features including scalable UI components, colour scheme options, and a new toolbar. Conducted unit and functional testing to ensure improved usability for visually impaired users.',
        ...
        Project::create([
            ...
            'details' => 'Developed a personal portfolio website to professionally present my search for a new career in software engineering. The site features sections for projects, skills, professional experience, and a contact form, all designed with a responsive layout to provide a seamless user experience across devices.',
        ...
        Project::create([
            ...
            'details' => 'Applied J48 decision trees in WEKA to analyse breast cancer datasets, optimizing models with cross-validation and parameter tuning. Identified critical diagnostic attributes that aligned with clinical practices, enhancing model interpretability and accuracy.',
